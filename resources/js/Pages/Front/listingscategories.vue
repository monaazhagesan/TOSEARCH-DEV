...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/listings_list_with_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Oct 2023 04:16:45 GMT -->
<head>
          ...
          <div class="header_widget"> <a href="#login_with_otp" class="button border with-icon popup-with-zoom-anim"><i class="sl sl-icon-bag"></i>Seller Tools</a> <a href="#dialog_signin_part" class="button border sign-in popup-with-zoom-anim"><i class="sl sl-icon-user"></i> Buyer Tools</a>
            <div class="utf_user_menu">
              ...
              <ul>
                ...
                <li><a :href="route('home')"><i class="sl sl-icon-power"></i>Sign Out</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div id="login_otp" class="zoom-anim-dialog mfp-hide">
          ...
          <div class="utf_signin_form style_one" style="text-align: center;">
            ...
            <div class="utf_row_form">
             <a href="dashboard.html" class="button border with-icon"> Validate</a>
            </div>
            </form>
          </div>
        </div>
      ...
      <div class="col-lg-8 col-md-8">
        <div class="listing_filter_block">
          <div class="col-md-2 col-xs-2">
            <div class="utf_layout_nav"> <a :href="route('listingsgridcategories')" class="grid"><i class="fa fa-th"></i></a> <a href="#" class="list active"><i class="fa fa-align-justify"></i></a> </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="utf_listing_item-container list-layout"> <a :href="route('listingdetails')" class="utf_listing_item">
              <div class="utf_listing_item-image"> 
          <img src="images/automatic-rotary.jpg" alt=""> 
          <div class="utf_listing_prige_block utf_half_list">     
          </div>
        </div>
        <span class="utf_open_now">Industry Leader</span>
              <div class="utf_listing_item_content">
                <div class="utf_listing_item-inner">
                  <h3>Automatic Solid Brick Making Machine</h3>
                  <p><b>Brick Raw Material:</b> Concrete</p>
                  <p><b>Brick Type:</b> Solid</p>
                  <p><b>Automation Grade:</b> Automatic</p>
                  <p class="read" style="text-decoration: underline;">read more...</p>
                  <div style="margin-top: 12px;"><button class="button border contactsupplier">Contact Supplier</button></div>
                </div>
              </div>
              </a> 
      </div>
          ...
          <div class="col-lg-12 col-md-12">
             <div class="utf_listing_item-container list-layout"> <a :href="route('listingdetails')" class="utf_listing_item">
              <div class="utf_listing_item-image"> 
          <img src="images/fully-automatic.webp" alt=""> 
          <div class="utf_listing_prige_block utf_half_list">     
          </div>
        </div>
        <span class="utf_open_now">Leading Supplier</span>
              <div class="utf_listing_item_content">
                <div class="utf_listing_item-inner">
                  <h3>Automatic Solid Brick Making Machines Manufacturer In Kolkata</h3>
                  <p><b>Automatic:</b> Automatic</p>
                  <p><b>Brick Type:</b> Solid</p>
                  <p><b>Solid:</b> MIXWELL</p>
                  <p class="read" style="text-decoration: underline;">read more...</p>
                  <div style="margin-top: 12px;"><button class="button border contactsupplier">Contact Supplier</button></div>
                </div>
              </div>
        ...
        <span class="utf_open_now">Leading Supplier</span>
              <div class="utf_listing_item_content">
                <div class="utf_listing_item-inner">
                  <h3>Movable Egg Laying Brick Making Machine</h3>
                  <p><b>Model Number:</b> 650 TRIPLE VIBRATOR</p>
                  <p><b>Voltage:</b> 240- 280 VOLT</p>
                  <p><b>Motor Make:</b> CROMPTON</p>
                  <p class="read" style="text-decoration: underline;">read more...</p>
                  <div style="margin-top: 12px;"><button class="button border contactsupplier">Contact Supplier</button></div>
                </div>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
             <div class="utf_listing_item-container list-layout"> <a :href="route('listingdetails')" class="utf_listing_item">
              <div class="utf_listing_item-image"> 
          <img src="images/cement-bricks-making-machine.jpg" alt=""> 
          <div class="utf_listing_prige_block utf_half_list">     
          </div>
        </div>
        <span class="utf_open_now">Industry Leader</span>
              <div class="utf_listing_item_content">
                <div class="utf_listing_item-inner">
                  <h3>MS Automatic Brick Making Machine</h3>
                  <p><b>Brick Type:</b> Solid</p>
                  <p><b>Automation Grade:</b>Automatic</p>
        ...
        <div class="sidebar">
          ...
          <div class="utf_box_widget margin-top-35 margin-bottom-75">
            ...
            <ul class="utf_listing_detail_sidebar">
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Plywoods</a></li>
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Laminate Sheets</a></li>
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Wood Boards</a></li>
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Wall Panels</a></li>
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Hardwood</a></li>
              <li><i class="fa fa-angle-double-right"></i> <a href="#">Particle Board</a></li>
            </ul>
          </div>
        </div>
      </div>
